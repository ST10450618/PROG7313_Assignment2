...
This project made use of **Claude (Anthropic)** as an AI coding assistant
during the development of Part 2 of this Portfolio of Evidence.

| Aspect | Detail |
|---|---|
| **Tool used** | Claude by Anthropic (claude.ai) |
| **Parts assisted** | Code scaffolding, MVVM architecture setup, Jetpack Compose UI implementation, GitHub Actions workflow configuration, and README structure |
| **Extent of use** | AI-generated code was reviewed, tested, understood, and integrated by each group member. No code was submitted without being read and verified by the student responsible for that section. |
| **Understanding** | All group members can explain every line of code in their assigned section. The logic, design patterns, and architectural decisions were discussed and understood before submission. |
| **Academic integrity** | Use of AI assistance is disclosed in full compliance with The IIE's Student Conduct, Discipline and Safety Policy (IIE015). This disclosure is made proactively to avoid any penalty associated with non-disclosure. |

> **Group declaration:** We, the undersigned members of this group, confirm
> that the above disclosure is accurate and complete. We understand the
> content we have submitted and can defend it in an academic context.
>
...
> Replace `ST10XXXXXX` with your actual student numbers before submitting.
...
**[▶️ Watch the Demo on YouTube](https://youtu.be/YOUR_LINK_HERE)**

> Replace the link above with your unlisted YouTube URL before submitting.

The video demonstrates all required features of the BudgetWise prototype
running on an Android emulator (API 34). Runtime: approximately 5–7 minutes.
...
*BudgetWise · PROG7313 / OPSC7311 · The Independent Institute of Education · 2026*
